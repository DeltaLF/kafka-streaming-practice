...
public class GreetingsTopology {
    ...
    public static Topology buildTopology() {
        ...
        greetingsStream.print(Printed.<String, String>toSysOut().withLabel("greetingStream"));

        var modifiedStream = greetingsStream.mapValues((readOnlyKey, value) -> value.toUpperCase());

        greetingsStream.print(Printed.<String, String>toSysOut().withLabel("modifiedStream"));
